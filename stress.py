...
def decimal_to_base6_1to6(decimal_number):
    result = ''
    while decimal_number > 0 or len(result) < 3:
        remainder = decimal_number % 6 + 1
...
decimal_number = 123
base6_number = decimal_to_base6_1to6(decimal_number)
print(f"Число {decimal_number} в шестеричной системе начиная с 1: {base6_number}")

print("Все трехзначные числа в шестиричной системе начиная с 1:")
for i in range(0, 6 * 6 * 6):
    print(decimal_to_base6_1to6(i))
